...
export const QuickCourse = () => {
  ...
  const handleAddSupplement = async (
    ...
    try {
      ...
      setError('Не удалось добавить добавку. Попробуйте снова или перезагрузите приложение.')
    } finally {
  ...
  const handleGenerateCourse = async () => {
    ...
    try {
      ...
      setError('Не удалось сгенерировать курс. Попробуйте снова или перезагрузите приложение.')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className='relative p-4 py-40 pt-35 max-w-md mx-auto bg-blue-50'>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
      >
        {loading ? 'Генерация...' : isAddingSupplement ? 'Добавление добавок...' : 'Сгенерировать курс'}
      </motion.button>
      {course && (
        <>

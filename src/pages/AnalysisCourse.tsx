	...
	return (
		<div className='p-4 py-34 max-w-md mx-auto'>
			...
			<motion.button
				...
				className='bg-blossom-pink text-text-primary p-3 rounded-lg w-full mb-6 font-medium shadow-md border border-white'
			...
			{course && (
				<>
					...
					<motion.button
						...
						className='bg-lavender text-text-primary p-3 rounded-lg w-full font-medium shadow-md border border-white flex items-center justify-center'
						whileHover={{
							scale: 1.03,
